...
=======
# EduChainGPT
An AI-powered teaching assistant built with LangChain and OpenAI’s GPT models. EduChainGPT generates custom syllabuses, explains concepts step-by-step, and guides learners through topics interactively — following structured lesson plans while adapting to student responses.
>>>>>>> origin/main
